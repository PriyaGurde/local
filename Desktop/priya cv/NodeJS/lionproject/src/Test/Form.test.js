...
expect(div).toHaveTextContent('It should be Number in range')
...
expect(div).toHaveTextContent('emailid should have @ and dot format')
...
expect(window.alert).toBeCalledWith('saved the form')
